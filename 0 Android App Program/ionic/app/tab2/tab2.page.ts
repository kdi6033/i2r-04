...
export class Tab2Page implements OnDestroy, DoCheck {
  ...
  constructor(
    ...
    this.globalService.vbat$.subscribe(() => {
      this.vbatUpdated = true;
      setTimeout(() => this.vbatUpdated = false, 1000); // Reset flag after 1 second
    });

    this.globalService.adc$.subscribe(() => {
      this.adcUpdated = true;
      setTimeout(() => this.adcUpdated = false, 1000); // Reset flag after 1 second
    });
